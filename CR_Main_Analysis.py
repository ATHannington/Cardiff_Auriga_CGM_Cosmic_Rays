...
ylabel = {
    ...
    "Grad_T" : r"Abs. Temperature Gradient (K cm$^{-1}$)",
    "Grad_n_H" : r"Abs. n$_H$ Gradient (cm$^{-4}$)",
    "Grad_bfld" : r"Abs. B-Field Gradient ($ \mu $G cm$^{-1}$)",
    "Grad_P_CR" : r"Abs. P$_{CR}$ Gradient (K cm$^{-4}$)",
